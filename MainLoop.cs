...
namespace Chromaria
{
    class MainLoop : Simulator
    {
        ...
        private void InitializeRegions()
        {
            ...
            // If we're in replay mode, load the background from a file
            if (replayRun)
            {
            ...
            // Otherwise, generate a blank one.
            else
            {
                if (stripedBackground)
        ...
        private NNControlledCreature generateCreatureFrom(NNControlledCreature parent)
        {
            ...
            NNControlledCreature offspring = new NNControlledCreature(newMorphology, initialBoardWidth / 2, initialBoardHeight / 2, initialHeading, generatedController, this, drawSensorField, trackPlanting, defaultNumSensors, freezeAfterPlanting, newControllerCPPNGenome, newMorphologyCPPNGenome);
        ...
        private Texture2D ReadBackgroundFromFile(string fileName)
        {
