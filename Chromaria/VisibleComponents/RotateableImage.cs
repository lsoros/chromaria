...
namespace Chromaria.VisibleComponents
{
    /// <summary>
    ...
    public class RotateableImage : Image
    {
        ...
        {
            if (!frozen)
                Simulator.spriteBatch.Draw(Texture, Position + center, null, Color.White, XNAHeading, center, 1.0f, SpriteEffects.None, Depth);
        }
